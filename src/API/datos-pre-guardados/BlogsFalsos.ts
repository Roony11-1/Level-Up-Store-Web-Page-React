...
export function BlogsFalsos() 
{
    return [
        new Blog()
                    ...
                    .setImagen("../../../public/TGS25-PC-Gamer.png")
                    .setUrl("https://lado.mx/noticia/19110584"),

                new Blog()
                    .setId(2)
                    .setTitulo("CASO CURIOSO #2")
                    ...
                    .setImagen("../../../public/caidaxhollow knigth.png")
                ...
                new Blog()
                    ...
                    .setImagen("../../../public/juegosPlus.png")
